...
<button class="button button2" onclick="window.location.href='admin.jsp'">Back</button>
  ...
  <br><span style="color:red"><%
      ...
      String t2=request.getParameter("t2");
            ...
            db.rst=db.stmt.executeQuery("SELECT DISTINCT g_name FROM guide_allot where g_name='"+t1+"'");
            ...
            String id6=null;
                      ...
                      ResultSet rs=st.executeQuery("select group_id,pro_name,session,course from guide_allot where g_name='"+db.rst.getString(1)+"' and session='"+t2+"'");
