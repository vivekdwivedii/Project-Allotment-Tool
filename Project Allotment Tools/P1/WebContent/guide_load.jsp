...
%>
    ...
    <h2 style='float:right;color:red;margin-right: 100px'>Total Guide:<%out.println(cnt);}%></h2>
<button class="button button2" onclick="window.location.href='admin.jsp'">Back</button>
  ...
  <center>
      <table border=1 style='border-collapse:collapse'>
          <h1 style="font-size:40px;color:#008CBA;">Guide Load</h1>
      ...
      String course=request.getParameter("course");
            ...
            db.rst=db.stmt.executeQuery("SELECT DISTINCT g_name FROM guide_allot");
             out.println("<html><head></head><body style='background-image:url(city_scape5b.jpg);background-repeat: no-repeat;background-position: right top;background-attachment: fixed;'>"
                     ...
                     + "<br><table border=2 style='width:1000px;border-collapse:collapse'><tr style='background-color:skyblue'><th>Guide ID</th><th>Guide Name</th><th>Number Of Groups</th><th>Names of the Student</th><th>Rol NUmbers</th><th>Pro. Name</th><th>Course</th></tr>");
            //int i=1;
             while(db.rst.next())
            ...
            String id6=null;
                      ...
                      {// out.println(rs.getString(1));
                       ...
                       i++;
                           ...
                           out.println("<tr><th>"+id6+"</th><th>"+db.rst.getString(1)+"</th><th>"+i+"</th><th>"+name2+"</th><th>"+rol+"</th><th>"+rno+"</th><th>"+crs+"</th></tr>");
