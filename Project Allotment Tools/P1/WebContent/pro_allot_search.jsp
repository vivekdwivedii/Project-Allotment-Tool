...
%>
    ...
    %>
<button class="button button2" onclick="window.location.href='project.jsp'">Back</button>
<button class="button button2" onclick="window.location.href='admin.jsp'">Home</button>
<center>
<form action="pro_allot">
<fieldset style="width:30%">
<legend style="color:#FFFFFF;font-size:30px"><b>Project Allotment</b></legend>
